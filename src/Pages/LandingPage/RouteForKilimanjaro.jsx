...
//     {
//         image: northcircuit,
//         title: "Northern Circuit Route (9 Days)",
//         price: "On Request",
...
// const RouteForKilimanjaro = forwardRef ( ({ onChange, scrollToPlanningDays }, ref) => {
...
//     return (
//         <section className="py-8 md:py-12 px-4 md:px-10 lg:px-16 xl:px-18 2xl:px-28 mx-auto">
//             <div className="">
//                 {/* Heading */}
...
//         const updated = prev.includes(routeTitle)
//           ? prev.filter((r) => r !== routeTitle)
//           : [...prev, routeTitle];
...
//     // sync selected routes to parent form
//     useEffect(() => {
//       onChange?.(selectedRoutes);
//     }, [selectedRoutes, onChange]);
...
//     return (
      ...
      //         key={index}
      //         {...route}
      //         isSelected={selectedRoutes.includes(route.title)}
