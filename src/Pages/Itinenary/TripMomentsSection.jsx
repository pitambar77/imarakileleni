      ...
      {activeIndex !== null && (
        <div className="fixed inset-0 bg-black/80 flex flex-col justify-center items-center z-50">
          <div className="bg-[#fee3cc] rounded-lg max-w-6xl w-[95%] p-6 relative flex flex-col md:flex-row">
            ...
            <img
              src={moments[activeIndex].image}
              className="h-[480px] w-[420px] object-cover rounded"
            />
          ...
          <button
            onClick={nextImage}
            className="absolute right-20 top-1/2 bg-white p-2 rounded-full"
          >
            <FaChevronRight />
          </button>
            ...
            {moments.map((m, i) => (
              <img
                ...
                className={`w-20 h-20 object-cover rounded cursor-pointer ${
                  i === activeIndex ? "ring-2 ring-[#d87028]" : "opacity-70"
                }`}
              />
            ))}
          </div>
