...
const ChoosingSafariSection = () => {
  ...
  return (
    <section
      id="packages"
      className="bg-[#fde6d5] py-8 md:py-16 px-4 md:px-10 lg:px-16 xl:px-18 2xl:px-28"
    >
      {/* Heading */}
      <div className="mb-12 max-w-5xl mx-auto text-center">
        <h2 className="text-2xl md:text-3xl capitalize font-extrabold text-[#111] mb-4">
        ...
        <p className="text-[16px] text-[#333] leading-relaxed mb-5">
          Tanzania safaris work best when they reflect how people actually like
          to travel, not when they are fixed plans copied from elsewhere.
        </p>
        <p className="text-[16px] text-[#333] leading-relaxed mb-5">
        ...
        <p className="text-[16px] text-[#333] leading-relaxed mb-5">
          From popular northern parks to quieter wildlife areas, each package is
          planned with realistic drive times, clear inclusions, and flexibility
          once on safari.
        </p>
        <p className="text-[16px] text-[#333] leading-relaxed mb-5">
          Across all styles, the aim remains steady days, comfortable stays,
          thoughtful guiding, and wildlife experiences that feel natural rather
          than hurried.
        </p>
      </div>
          ...
          <TripCard
            ...
            trip={{
              ...
              places: trip.itinerary?.length
                ? `${trip.itinerary.length} Places`
                : "Multiple Places",
              country: "1 Country",
              standardPrice: trip.standardPrice,
