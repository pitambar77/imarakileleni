...
//   return (
//     <section id="thingstodo" className="bg-white py-16 px-4 md:px-10 lg:px-16 xl:px-18 2xl:px-28">
//       {/* TOP SECTION */}
...
//                   activeTab === tab.id
//                     ? "bg-black text-white "
//                     : "bg-[#d87028] text-[#222] hover:bg-orange-300 border-orange-300"
//                 }`}
//               >
...
//   // We take first migration block (your API structure)
...
//     <section
//       id="thingstodo"
//       className="bg-white py-16 px-4 md:px-10 lg:px-16 xl:px-18 2xl:px-28"
//     >
//       {/* TOP SECTION */}
...
//                 <p
//                   key={i}
//                   className="text-[15px] text-gray-700 leading-relaxed mb-6"
//                 >
//                   {d.content}
//                 </p>
//               ))}
