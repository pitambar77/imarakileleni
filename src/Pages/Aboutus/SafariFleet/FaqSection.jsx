...
const FaqSection = () => {
  ...
  return (
    <section className="bg-white py-16 px-4 md:px-10 lg:px-16 xl:px-18 2xl:px-28">
      {/* Title */}
      <h2 className="text-[28px] md:text-3xl text-center capitalize font-extrabold text-[#111] mb-8">
       *Wanna know how we crunched the number?
      </h2>
      <p className=" text-center mb-12">Wonder no more.(*Prices correct at time of analysis - May 2025.)</p>
