...
const tours = [
  ...
  },
  {
    id: 2,
    image:
      "https://africanparadisesafari.com/wp-content/uploads/2025/05/Tanzania-Private-Safaris-20252027.jpg",
    badge: "EARLY ACCESS DEAL",
    title: "Sea, Safari, South Africa",
    region: "South Africa",
    duration: "2–4 weeks",
  ...
  },
  {
    id: 5,
    image:
      "https://ismanitours.com/wp-content/uploads/2017/06/6-days-Tanzania-safari.jpg",
    badge: "EARLY ACCESS DEAL",
    title: "Sea, Safari, South Africa",
    region: "South Africa",
    duration: "2–4 weeks",
    ...
    <section className="bg-white py-16 px-4 md:px-10 lg:px-16 xl:px-18 2xl:px-28">
      ...
      <div className="lg:hidden flex justify-center mb-6">
        <button
          ...
          className="bg-[#d87028] text-white w-full py-2 rounded-md font-semibold uppercase"
        >
          Filter
        </button>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-4 ">
        {/* DESKTOP SIDEBAR */}
        <aside className="hidden lg:block lg:col-span-1 bg-[#fafafa] p-6 rounded-md shadow-sm border border-gray-200 h-fit">
          <div className="flex justify-between items-center mb-6">
            <h3 className="text-lg font-bold text-[#111]">Filter</h3>
            <button
              onClick={resetFilters}
            ...
            <div key={category} className="mb-6 border-b border-gray-200 pb-3">
              ...
              {category === "region" && (
                <div className="flex items-center gap-2 px-4 mb-4 bg-[#222] py-1 rounded-md text-[#d87028]  font-semibold text-[16px]">
                  {/* <FaMapMarkerAlt className="" /> */}
                  <img
                    src="https://static.vecteezy.com/system/resources/previews/023/639/560/non_2x/tanzania-map-in-africa-icons-showing-tanzania-location-and-flags-png.png"
                    alt=""
                    className="w-10 h-10"
                  />
                  <span className=" ">Tanzania Destinations</span>
        ...
        >
          ...
          <div
            className={`absolute top-0 left-0 h-full w-72 bg-white px-5 py-6 shadow-lg transform transition-transform duration-300 ${
          ...
          >
            ...
            {Object.entries(filters).map(([category, options]) => (
              <div
                key={category}
                className="mb-6 border-b border-gray-200 pb-3"
              >
                <button
                  onClick={() => toggleSection(category)}
                  className="flex items-center justify-between w-full text-[16px] font-semibold text-[#111]  mb-3"
            ...
            <button
              onClick={resetFilters}
              className="bg-[#d87028] hover:bg-orange-700 text-white w-full py-2 rounded-md mt-6"
            >
              RESET
            </button>
          </div>
        ...
        <div className="lg:col-span-3 grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
          {filteredTours.length > 0 ? (
            filteredTours.map((tour) => (
              // <div
              //   key={tour.id}
              //   className="bg-white rounded-md shadow-md hover:shadow-lg transition overflow-hidden border border-gray-100 h-[460px]"
              // >
              //   <div className="relative">
              //     <img
              //       src={tour.image}
              ...
              //     <p className="text-[16px] mb-4">{tour.description}</p>
              ...
              <div
                key={tour.id}
                className="bg-white rounded-md shadow-md hover:shadow-lg transition overflow-hidden border border-gray-100 flex flex-col h-full"
              >
                <div className="relative">
                  <img
                    src={tour.image}
                ...
                <div className="p-5 text-left flex flex-col flex-grow">
                  ...
                  <div className="flex justify-between items-center mt-auto pt-4">
                    ...
                    <button className="bg-[#d87028] hover:bg-orange-700 text-white text-sm px-6 py-2 rounded-full mt-2">
                      VIEW TRIP
                    </button>
                  </div>
                </div>
