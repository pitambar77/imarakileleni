...
//         existingImage: item.image || null, // 👈 ADD THIS
//         image: null, // important: only upload if changed
...
//   const addOverview = () =>
//     setOverviewinfo([...overviewinfo, { title: "", subtitle: "", description: [], image: null, imagePreview: null }]);
...
//     overviewinfo.forEach((item) => item.image && data.append("overviewImages", item.image));
//     adventure.forEach((item) => item.image && data.append("adventureImages", item.image));

//     try {
//       let res;
//       if (editData) {
//         res = await API.put(`/travelgroup/${editData._id}`, data);
//       } else {
//         res = await API.post("/travelgroup", data);
//       }
...
//     } catch (err) {
//       console.error(err);
//       alert("Error saving travel group");
//     }
//   };
